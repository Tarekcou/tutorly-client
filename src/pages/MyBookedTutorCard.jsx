...
const MyBookedtutorsCard = ({ tutor, user, handleDelete }) => {
  ...
  return (
    <div>
      <div className="relative flex md:flex-row flex-col items-center gap-5 shadow-lg p-3 py-5 rounded-lg hover:ring-2">
        ...
        <div
          ...
          className="top-2 right-2 absolute text-red-600 text-3xl"
        >
          <button>
